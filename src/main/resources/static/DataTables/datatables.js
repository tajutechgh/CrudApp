 ...
 *   https://datatables.net/download/#dt/dt-2.3.4/b-3.2.5/fh-4.0.3/r-3.0.6/sb-1.8.4/sp-2.3.5/sl-3.1.0
 *
 * Included libraries:
 *   DataTables 2.3.4, Buttons 3.2.5, FixedHeader 4.0.3, Responsive 3.0.6, SearchBuilder 1.8.4, SearchPanes 2.3.5, Select 3.1.0
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.3.4/b-3.2.5/fh-4.0.3/r-3.0.6/sb-1.8.4/sp-2.3.5/sl-3.1.0",
